...
| phase-8b | [001](./phase-8b/001-2026-05-25-phase-8b-complete.md) | 2026-05-25 | Phase 8b COMPLETE — PriceTickService implemented as pure orchestrator; B1-B5 all green (9 tests), ruff/format/mypy clean, no regressions (439/439); two `Settings` additions declared (`activity_tick_k=0.5`, `vc_extra_boost_multiplier=1.03`); digest written |
