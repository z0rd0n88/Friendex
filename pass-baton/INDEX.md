...
| phase-8d | [001](./phase-8d/001-2026-05-25-portfolio-stats-green.md) | 2026-05-25 | Phase 8d GREEN — Portfolio & Stats Services landed. 5 new files (3 prod + 2 test), zero modified. All D1–D10 pinned; 14/14 new tests pass, full suite 500/500. Gate green (ruff/format/mypy). Coverage 92% combined on the 3 new prod modules (snapshot_models 100%, portfolio_service 89%, stats_service 90% — gaps are defensive `None`-guards). Ready for review + commit/PR |
