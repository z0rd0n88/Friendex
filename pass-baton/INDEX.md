...
| phase-6-repos | [014](./phase-6-repos/014-2026-05-25-migrator-error-handling.md) | 2026-05-25 | H2 migrator error-handling — corrupt source data maps to `MigrationError` + clean exit 1 (named file/record/field, no traceback); shape validation added; gate green, 3 new + 12 prior migrator tests pass |
